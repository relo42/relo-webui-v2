...
export const tourSteps: Array<Step> = [
  ...
  // Step 8: Terminal
  {
    ...
    content:
      'Built-in terminal for quick commands. Execute shell commands without leaving Relo WebUI.',
  },
  ...
  // Step 10: Settings
  {
    ...
    content:
      'Configure providers, themes, accent colors, and more. Make Relo WebUI yours.',
  },
  // Step 11: Finish
  {
    target: 'body',
    ...
    content:
      'Start chatting with your AI, explore the tools, and customize Relo WebUI to fit your workflow. Need help? Press ? to see all keyboard shortcuts.',
  },
]
